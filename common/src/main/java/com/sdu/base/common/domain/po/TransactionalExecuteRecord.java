package com.sdu.base.common.domain.po;
...
public class TransactionalExecuteRecord {
    ...
    private TransactionalExecuteDTO transactionalExecuteDTO;
    ...
    @TableField("status")
    @Builder.Default
    private byte status = TransactionalExecuteRecord.STATUS_WAIT;
